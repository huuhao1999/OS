...
use FSP_Google\Auth\ApplicationDefaultCredentials;
use FSP_Google\Auth\Cache\MemoryCacheItemPool;
use FSP_Google\Auth\CredentialsLoader;
use FSP_Google\Auth\HttpHandler\HttpHandlerFactory;
use FSP_Google\Auth\OAuth2;
use FSP_Google\Auth\Credentials\ServiceAccountCredentials;
use FSP_Google\Auth\Credentials\UserRefreshCredentials;
use FSP_GuzzleHttp\Client;
use FSP_GuzzleHttp\ClientInterface;
use FSP_GuzzleHttp\Ring\Client\StreamHandler;
...
class Google_Client
{
  ...
  /**
   * @var FSP_Google\Auth\OAuth2 $auth
   */
  private $auth;

  /**
   * @var FSP_GuzzleHttp\ClientInterface $http
   */
  private $http;
   ...
   *
   * @param FSP_GuzzleHttp\ClientInterface $http the http client object.
   * @return FSP_GuzzleHttp\ClientInterface the http client object
   */
  ...
  /**
   * @return FSP_Google\Auth\OAuth2 implementation
   */
   ...
   * @param FSP_GuzzleHttp\ClientInterface $http
   */
  ...
  /**
   * @return FSP_GuzzleHttp\ClientInterface implementation
   */
