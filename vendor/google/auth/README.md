...
Next, run the FSP_Composer command to install the latest stable version:
...
the `FSP_Google\Auth\AccessToken` class to verify the ID token:

```php
use FSP_Google\Auth\AccessToken;
