...
namespace FSP_Google\Auth\Subscriber;

use FSP_Google\Auth\FetchAuthTokenInterface;
use FSP_Google\Auth\GetQuotaProjectInterface;
use FSP_GuzzleHttp\Event\BeforeEvent;
use FSP_GuzzleHttp\Event\RequestEvents;
use FSP_GuzzleHttp\Event\SubscriberInterface;
