...
use FSP_Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
    ...
    {
        if (defined('FSP_GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            return ClientInterface::MAJOR_VERSION;
        }

        if (defined('FSP_GuzzleHttp\ClientInterface::VERSION')) {
    ...
    public static function makeHttpClient(
        ...
        if (self::getGuzzleMajorVersion() === 5) {
            $client = new \FSP_GuzzleHttp\Client($httpClientOptions);
        ...
        $stack = \FSP_GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \FSP_GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
