...
namespace FSP_Google\Auth;

use DomainException;
use FSP_Google\Auth\Credentials\AppIdentityCredentials;
...
use FSP_Google\Auth\Subscriber\AuthTokenSubscriber;
 ...
 *
 * This allows it to be used as follows with FSP_GuzzleHttp\Client:
 *
 * ```
