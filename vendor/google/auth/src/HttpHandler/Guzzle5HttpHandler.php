 ...
 */
namespace FSP_Google\Auth\HttpHandler;

use Exception;
use FSP_GuzzleHttp\ClientInterface;
use FSP_GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!class_exists('FSP_GuzzleHttp\Promise\Promise')) {
