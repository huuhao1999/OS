...
namespace FSP_Google\Auth\Credentials;

use FSP_Google\Auth\CredentialsLoader;
use FSP_Google\Auth\GetQuotaProjectInterface;
use FSP_Google\Auth\HttpHandler\HttpClientCache;
use FSP_Google\Auth\HttpHandler\HttpHandlerFactory;
use FSP_Google\Auth\Iam;
use FSP_Google\Auth\ProjectIdProviderInterface;
use FSP_Google\Auth\SignBlobInterface;
use FSP_GuzzleHttp\Exception\ClientException;
use FSP_GuzzleHttp\Exception\ConnectException;
use FSP_GuzzleHttp\Exception\RequestException;
use FSP_GuzzleHttp\Exception\ServerException;
use FSP_GuzzleHttp\Psr7\Request;
 ...
 *
 *   use FSP_Google\Auth\Credentials\GCECredentials;
 *   use FSP_Google\Auth\Middleware\AuthTokenMiddleware;
