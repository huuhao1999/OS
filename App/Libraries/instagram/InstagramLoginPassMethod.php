    ...
    private function configurePhoto ( $photo, $caption, $uploadId, $link = '', $target = 'timeline' )
    {
        ...
        if( $target == 'story' )
        {
            ...
            if ( ! empty( $link ) )
            {
                ...
                $tap_models = ',"tap_models":"[{\"x\":0.5126011,\"y\":' . $link_y . ',\"z\":0,\"width\":0.50998676,\"height\":0.25875,\"rotation\":0.0,\"type\":\"story_link\",\"is_sticker\":true,\"selected_index\":0,\"tap_state\":0,\"link_type\":\"web\",\"url\":\"' . $link . '\",\"tap_state_str_id\":\"link_sticker_default\"}]"}';
            }
