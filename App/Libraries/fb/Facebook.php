...
class Facebook extends SocialNetwork
{
	...
	public function sendPost ( $nodeFbId, $type, $message, $preset_id, $link, $images, $video, $poster = NULL )
	{
		$sendData = [
			'message' => $message
		];
	...
	public function authorize ()
	{
		...
		else
		{
			...
			DB::DB()->delete( DB::table( 'account_access_tokens' ), [ 'account_id' => $fb_accId, 'app_id' => $this->appInfo[ 'id' ] ] );
		}
