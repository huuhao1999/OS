...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Link card view – shares the post link and the custom message. Tumblr fetches the post as a link card view;<br>Only custom message – shares the custom message without any image or link;<br>Featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message;<br>Quote - Shares the custom message as a quote. Note that post images will not be shared inside the quote.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<select name="fs_tumblr_posting_type" id="fspTumblrPostingType" class="fsp-form-select">
			<option value="1" <?php echo Helper::getOption( 'tumblr_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo fsp__( 'Link card view' ); ?></option>
			<option value="4" <?php echo Helper::getOption( 'tumblr_posting_type', '1' ) == '4' ? 'selected' : ''; ?>><?php echo fsp__( 'Only custom message' ); ?></option>
			<option value="2" <?php echo Helper::getOption( 'tumblr_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo fsp__( 'Featured image' ); ?></option>
			<option value="3" <?php echo Helper::getOption( 'tumblr_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo fsp__( 'All post images' ); ?></option>
			<option value="5" <?php echo Helper::getOption( 'tumblr_posting_type', '1' ) == '5' ? 'selected' : ''; ?>><?php echo fsp__( 'Quote' ); ?></option>
		</select>
	</div>
</div>
<div class="fsp-settings-row">
	...
	<div class="fsp-settings-col">
		<input autocomplete="off" class="fsp-form-input" name="fs_post_title_tumblr" value="<?php echo esc_html( Helper::getOption( 'post_title_tumblr', "" ) ); ?>">
	</div>
</div>
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
	...
	<div class="fsp-settings-collapse">
		<div class="fsp-settings-col">
			...
			<div class="fsp-custom-post" data-preview="fspCustomPostPreview">
				<textarea name="fs_post_text_message_tumblr" class="fsp-form-textarea"><?php echo esc_html( Helper::getOption( 'post_text_message_tumblr', "<img src='{featured_image_url}'>\n\n{content_full}" ) ); ?></textarea>
		...
		<div class="fsp-settings-col">
			...
			<div class="fsp-settings-preview">
				...
				<div class="fsp-settings-preview-body">
					<span id="fspCustomPostPreview" class="fsp-settings-preview-body-text"><?php echo esc_html( Helper::getOption( 'post_text_message_tumblr', "<img src='{featured_image_url}'>\n\n{content_full}" ) ); ?></span>
