            ...
            <div class="fsp-settings-igcontrols">
                ...
                <div class="fsp-settings-igcontrol">
                    ...
                    <div class="fsp-settings-igcontrol-input">
                        ...
                        <input autocomplete="off" data-jscolor="{ previewElement: '' }" class="fsp-form-input jscolor" name="fs_instagram_story_link_background" value="<?php echo Helper::getOption( 'instagram_story_link_background', 'FFFFFF' ); ?>" data-type="link-background-color">
                    </div>
                </div>
                <div class="fsp-settings-igcontrol">
                    ...
                    <div class="fsp-settings-igcontrol-input">
                        <span>%</span>
                        <input autocomplete="off" class="fsp-form-input" name="fs_instagram_story_link_background_opacity" value="<?php echo Helper::getOption( 'instagram_story_link_background_opacity', '100' ); ?>" data-type="link-background-opacity">
                    </div>
                </div>
                <div class="fsp-settings-igcontrol">
                    ...
                    <div class="fsp-settings-igcontrol-input">
                        ...
                        <input autocomplete="off" data-jscolor="{ previewElement: '' }" class="fsp-form-input" name="fs_instagram_story_link_color" value="<?php echo Helper::getOption( 'instagram_story_link_color', '#1A91D0' ); ?>" data-type="link-color">
                    </div>
                </div>
                <div class="fsp-settings-igcontrol">
                    ...
                    <div class="fsp-settings-igcontrol-input">
                        <span>px</span>
                        <input autocomplete="off" class="fsp-form-input" name="fs_instagram_story_link_top" value="<?php echo Helper::getOption( 'instagram_story_link_top', '1000' ); ?>" data-type="link-top">
                    </div>
                </div>
                <div class="fsp-settings-igcontrol">
                    ...
                    <div class="fsp-settings-igcontrol-input">
                        <span>px</span>
                        <input autocomplete="off" class="fsp-form-input" name="fs_instagram_story_link_left" value="<?php echo Helper::getOption( 'instagram_story_link_left', '30' ); ?>" data-type="link-left">
                    </div>
                </div>
                <div class="fsp-settings-igcontrol">
                    ...
                    <div class="fsp-settings-igcontrol-input">
                        <span>px</span>
                        <input autocomplete="off" class="fsp-form-input" name="fs_instagram_story_link_width" value="<?php echo Helper::getOption( 'instagram_story_link_width', '660' ); ?>" data-type="link-width">
                    </div>
                </div>
                <div class="fsp-settings-igcontrol">
                    ...
                    <div class="fsp-settings-igcontrol-input">
                        <span>px</span>
                        <input autocomplete="off" class="fsp-form-input" name="fs_instagram_story_link_font_size" value="<?php echo Helper::getOption( 'instagram_story_link_font_size', '50' ); ?>" data-type="link-font-size">
                    </div>
                </div>
                <div class="fsp-settings-igcontrol">
